...
//	WALK_SPEED : 300,
	...
	path : [
	    ...
	    {
	    	block :[
    	        	{ type : "MIDDLE", x : 400, y : -10, feature : "NORMAL" },
	    ...
	    },
	    {
	    	block :[
    	        	...
    	        	{ type : "SMALL", x : 300, y : -20, feature : "NORMAL" }
	        ]
	    },
	    {
	    	block :[
	    ...
	    {
	    	earth : { type : "SMALL", x : 10, y : 90, feature : "NORMAL" }
	    },
	    {
	    ...
	    {
	    	earth : { type : "LARGE", x : 200, y : 0, feature : "NORMAL" },
//	        item : [
