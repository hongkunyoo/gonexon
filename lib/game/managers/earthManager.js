	            ...
	            switch (TYPE) {
	                case EarthManager.TYPE.WHITE:
	                    return ig.game.spawnEntity(EntityEarth, x, y, {
	                        ...
	                        animSheet: new ig.AnimationSheet('media/earth0.png', 760, 120),
	                        size: { x: 760, y: 120 },
	                        maxVel: {x: 10000, y: 10000},
	                        vel: _settings ? _settings : ({ x: -600, y: 0 }), 
	                ...
	                case EarthManager.TYPE.YELLOW:
	                    return ig.game.spawnEntity(EntityEarth, x, y, {
	                        ...
	                        animSheet: new ig.AnimationSheet('media/earth1.png', 760, 120),	                  
	                        size: { x: 760, y: 120 },
	                        maxVel: {x: 10000, y: 10000},
	                        vel: _settings ? _settings : ({ x: -600, y: 0 }), 
	                        collides: ig.Entity.COLLIDES.FIXED,
	                ...
	                case EarthManager.TYPE.BLACK:
	                    return ig.game.spawnEntity(EntityEarth, x, y, {
	                        ...
	                        animSheet: new ig.AnimationSheet('media/earth2.png', 760, 120),
	                        size: { x: 760, y: 120 },
	                        maxVel: {x: 10000, y: 10000},
	                        vel: _settings ? _settings : ({ x: -600, y: 0 }), 
	                        collides: ig.Entity.COLLIDES.FIXED,
