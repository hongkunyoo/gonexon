...
GameOverScreen = ig.Game.extend({
	...
	draw: function() {
		...
		var score = GM.COIN;//코인*알파+시간*베타
		
		//this.instructText.draw('Total time: '+elapse, x, y+30, ig.Font.ALIGN.CENTER);
		this.instructText.draw('Total Coin: '+GM.COIN, x, y+40, ig.Font.ALIGN.CENTER);
		this.instruxtText.draw('Total Score: '+ score, x, y+10,ig.Font.ALIGN.CENTER);
		this.instruxtText.draw('Press Spacebar To Continue.', x, ig.system.height-40,ig.Font.ALIGN.CENTER);
	}
});
