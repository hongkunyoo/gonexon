...
LEVEL01 = {
	...
	path : [
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "SOAR" },
	    	block : { type : "SMALL", x : 10, y : 20, feature : "NORMAL" }, 
	    	monster : { type : "MONSTER01", x : 10, y : 10, feature : "NORMAL" },
	    	item : { type : "JUMP_GUIDE_LINE", x : -100, y : 10, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "WAVE" },
	    	block : { type : "SMALL", x : 10, y : 20, feature : "NORMAL" }, 
	    	monster : { type : "MONSTER01", x : 10, y : 10, feature : "NORMAL" },
	    	item : { type : "JUMP_GUIDE_LINE", x : 20, y : 10, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "NORMAL" },
	    	block : { type : "SMALL", x : 10, y : 20, feature : "NORMAL" }, 
	    	monster : { type : "MONSTER01", x : 10, y : 10, feature : "NORMAL" },
	    	item : { type : "JUMP_GUIDE_LINE", x : 10, y : 10, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "NORMAL" },
	    	block : { type : "SMALL", x : 10, y : 20, feature : "NORMAL" }, 
	    	monster : { type : "MONSTER01", x : 10, y : 10, feature : "NORMAL" },
	    	item : { type : "JUMP_GUIDE_LINE", x : 40, y : 10, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "NORMAL" },
	    	block : { type : "SMALL", x : 10, y : 20, feature : "NORMAL" }, 
