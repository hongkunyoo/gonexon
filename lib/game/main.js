...
MyGame = ig.Game.extend({
	...
	init: function() {
		...
		var block = this.spawnEntity(EntityBlock, 320, ig.system.height-10);
		var block = this.spawnEntity(EntityBlock, 380, ig.system.height-10);
		var block = this.spawnEntity(EntityBlock, 440, ig.system.height-10);
		var block = this.spawnEntity(EntityBlock, 500, ig.system.height-10);
