	...
	EntityCoin = ig.Entity.extend({
		...
		check: function(other){
			if(other.name == 'player'){
				...
				console.log(this.timer5.delta());
				if(this.timer5.delta()== -1){
					ig.game.screen.x= ig.game.screen.x-10;
					ig.game.screen.y= ig.game.screen.y-10;
					console.log("좀되라임마 ㅡ");
					this.kill();
				}
				if(this.timer5.delta()== -0.5)
					ig.game.screen.x= ig.game.screen.x+10;
					ig.game.screen.y= ig.game.screen.y+10;
					this.kill();
				}
