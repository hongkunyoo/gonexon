...
/*	        staticInstantiate: function () {
	        ...
	        addEarthAfterTail: function(){
		        ...
		        if(rnd == 0)
			        this.tail = this.getFromPool(this._earthSelector(),(this.tail.pos.x + this.tail.size.x + 90.05), this._chooseYPos());
	            ...
	            switch (TYPE) {
	                case EarthManager.TYPE.WHITE:	                
	                    return ig.game.spawnEntity(EntityEarth, x, y, {
	                        ...
	                        animSheet: new ig.AnimationSheet('media/new_img/earth/A_type01.png', 250, 270),
	                        size: { x: 250, y: 270 },
	                ...
	                case EarthManager.TYPE.BLACK:                	
	                    return ig.game.spawnEntity(EntityEarth, x, y, {
	                        ...
	                        animSheet: new ig.AnimationSheet('media/new_img/earth/C_type03.png', 350, 270),
	                        size: { x: 350, y: 270 },
	                        vel: _settings ? _settings : (GM.earthSpeed), 
	                        collides: ig.Entity.COLLIDES.FIXED,
