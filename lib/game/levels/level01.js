...
//	    	monster : [
//	    	        { type : "MONSTER01", x : 800, y : 10, feature : "NORMAL" }
//            ],
	    	item : [
	    	        { type : "CAN_ITEM", x : 700, y : 20, feature : "NORMAL" },
//					{ type : "A_PATTERN", x : 700, y : 20, feature : "NORMAL" },
	    ...
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "NORMAL" },
	    	item : [
				{ type : "SQUARE_7_2", x : 450, y : 80, feature : "NORMAL" },
				{ type : "SQUARE_7_2", x : 450, y : 110, feature : "NORMAL" }
    		]
	    },
	    {
	    ...
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "NORMAL" },
	    	item : [
	    	        { type : "SPRING", x : 600, y : 10, feature : "NORMAL" }
    	        ]
	    },
	    {
	    ...
	    {
	    	block :[
    	        	{ type : "SMALL", x : 400, y : 90, feature : "NORMAL" }
	        ]
	    },
	    {
	    	earth : { type : "MIDDLE", x : 300, y : 0, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "MIDDLE", x : 0, y : -50, feature : "NORMAL" },
	    	monster : [
    	           	{ type : "MONSTER01", x : 10, y : 0, feature : "NORMAL" },
    	           	{ type : "MONSTER01", x : 30, y : 0, feature : "NORMAL" }
           ]
	    },
	    {
	    	earth : { type : "MIDDLE", x : 0, y : -30, feature : "SOAR" }
	    },
	    {
	    	earth : { type : "MIDDLE", x : 500, y : 20, feature : "NORMAL" },
	    	monster : [
    	           	{ type : "MONSTER01", x : 10, y : 0, feature : "NORMAL" }
	           ]
	    },
	    {
	    	earth : { type : "MIDDLE", x : 200, y : 60, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "MIDDLE", x : 150, y : -20, feature : "SOAR" }
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 20, feature : "NORMAL" },
	    	monster : [
	    	           { type : "MONSTER01", x : 350, y : 0, feature : "NORMAL" },
	    	           { type : "MONSTER01", x : 100, y : 0, feature : "NORMAL" },
	           ]
	    },
	    {
	    	earth : { type : "SMALL", x : 0, y : 0, feature : "NORMAL" },
	    	monster : [
	    	           { type : "MONSTER01", x : 100, y : 20, feature : "NORMAL" },
	    	           { type : "MONSTER01", x : 100, y : 0, feature : "NORMAL" }
	           ]
	    },
	    {
	    	earth : { type : "MIDDLE", x : 150, y : 0, feature : "NORMAL" }
	    },
	    {
	    	block :[
    	        	{ type : "MIDDLE", x : 400, y : 70, feature : "NORMAL" },
    	        	{ type : "SMALL", x : 300, y : 70, feature : "NORMAL" }
	        ]
	    },
	    {
	    	block :[
    	        	{ type : "MIDDLE", x : 500, y : 70, feature : "NORMAL" },
    	        	{ type : "SMALL", x : 400, y : -20, feature : "NORMAL" }
	        ]
	    },
	    {
	    	block :[
    	        	{ type : "MIDDLE", x : 400, y : -10, feature : "VANISH" },
    	        	{ type : "SMALL", x : 600, y : 20, feature : "NORMAL" }
	        ]
	    },
	    {
	    	block :[
    	        	{ type : "MIDDLE", x : 500, y : -50, feature : "NORMAL" },
    	        	{ type : "SMALL", x : 300, y : -20, feature : "VANISH" }
	        ]
	    },
	    {
	    	block :[
    	        	{ type : "MIDDLE", x : 450, y : 0, feature : "NORMAL" },
    	        	{ type : "SMALL", x : 450, y : 20, feature : "NORMAL" }
	        ]
	    },
	    {
	    	earth : { type : "SMALL", x : 10, y : 90, feature : "VANISH" }
	    },
	    {
	    	earth : { type : "MIDDLE", x : 5, y : 0, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "LARGE", x : 5, y : 30, feature : "SINK" },
	    	monster : [
    	           { type : "MONSTER01", x : 100, y : 20, feature : "NORMAL" },
    	           { type : "MONSTER01", x : 100, y : 20, feature : "NORMAL" }
           ]
	    ...
	    {
	    	earth : { type : "LARGE", x : 0, y : 10, feature : "SINK" },
	    	monster : [
	    	           { type : "MONSTER01", x : 100, y : 20, feature : "NORMAL" },
	    	           { type : "MONSTER01", x : 100, y : 0, feature : "NORMAL" }
	           ]
	    ...
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "SINK" },
	    	monster : [
	    	           { type : "MONSTER01", x : 100, y : 20, feature : "NORMAL" },
	    	           { type : "MONSTER01", x : 100, y : 0, feature : "NORMAL" }
	           ]
	    ...
	    {
	    	earth : { type : "LARGE", x : 200, y : 0, feature : "VANISH" },
//	        item : [
//	                	{ type : "SPRING", x : 10, y : 0, feature : "NORMAL" },
//	                	{ type : "SPRING", x : 50, y : 0, feature : "NORMAL" },
//	                	{ type : "SPRING", x : 100, y : 0, feature : "NORMAL" }
//            ]
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "VANISH" },
//	        item : [
//	                	{ type : "SPRING", x : 0, y : 0, feature : "NORMAL" },
//	                	{ type : "SPRING", x : 50, y : 0, feature : "NORMAL" },
//	                	{ type : "SPRING", x : 500, y : 0, feature : "NORMAL" }
//            ]
	    },
	    {
	    	earth : { type : "LARGE", x : 0, y : 0, feature : "VANISH" },
	        item : [
	                	{ type : "SPRING", x : 360, y : 150, feature : "NORMAL" }
            ]
	    },
	    {
	    	earth : { type : "MIDDLE", x : 500, y : 0, feature : "NORMAL" }
	    },
	    {
	    	earth : { type : "LARGE", x : 5, y : 0, feature : "NORMAL" },
	        item : [
	                	{ type : "A_PATTERN", x : 100, y : 60, feature : "NORMAL" }
            ]
	    }
	],
